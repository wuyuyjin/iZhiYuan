...
// node_modules/.pnpm/unplugin-vue-components@0.24.1_vue@3.2.47/node_modules/unplugin-vue-components/dist/resolvers.mjs
...
function getSideEffects5(name, {
  ...
  const peerModules = modules.map(
    ({
      ...
      return (0, import_path.normalize)((0, import_path.join)(pack, path, file));
    }
  );
    ...
    resolve: (name) => {
      if (!components4) {
        ...
        try {
          ...
          indexesJson = JSON.parse((0, import_fs.readFileSync)(path, "utf-8"));
    ...
    resolve: (name) => {
      if (!directives) {
        ...
        try {
          const corePath = resolveModule("@vueuse/core") || process.cwd();
          const path = resolveModule("@vueuse/core/indexes.json") || resolveModule("@vueuse/metadata/index.json") || resolveModule("@vueuse/metadata/index.json", { paths: [corePath] });
          indexesJson = JSON.parse((0, import_fs2.readFileSync)(path, "utf-8"));
    ...
    resolve: async (name) => {
      if (!components5.length) {
        ...
        if (quasarApiListPath)
          components5 = JSON.parse(await import_fs3.promises.readFile(quasarApiListPath, "utf-8"));
      }
...
var debug = (0, import_debug.default)("unplugin-vue-components:resolvers:arco");
...
//# sourceMappingURL=unplugin-vue-components_resolvers.js.map
