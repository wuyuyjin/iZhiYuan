...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onSubmit = handleSubmit((values) => {
      ...
      axios.post(api + "/User/login", config).then((response) => {
        console.log(111111);
                  ...
                  _push3(ssrRenderComponent(_component_n_form, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="text-xs text-red-700" data-v-9ad034f2${_scopeId3}>${ssrInterpolate(unref(errors).email)}</div>`);
                        _push4(ssrRenderComponent(_component_n_form_item, {
                          label: "密码",
                          path: "password"
                        }, {
                        ...
                        _push4(`<div class="text-xs text-red-700" data-v-9ad034f2${_scopeId3}>${ssrInterpolate(unref(errors).password)}</div><br data-v-9ad034f2${_scopeId3}><button class="bg-green-500/100 rounded-lg w-1/4 h-10 text-white" data-v-9ad034f2${_scopeId3}> 登录 </button>`);
                      } else {
                        return [
...
const login_vue_vue_type_style_index_0_scoped_9ad034f2_lang = "";
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Login/login.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9ad034f2"]]);
export {
  Login as default
};
//# sourceMappingURL=login-8d4ff9c3.js.map
